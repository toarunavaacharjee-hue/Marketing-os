        ...
        <div className="relative flex items-center justify-between border-b border-slate-200 px-4 py-3.5">
          <Link href="/dashboard" className="flex items-center gap-2.5" onClick={onNavigate}>
            ...
            <span className="text-[13.5px] font-bold tracking-tight text-slate-800">
              Marketing <span className="text-primary">OS</span>
            </span>
          </Link>
          <button
            type="button"
              ...
              <div key={section.label} className="mb-1">
                ...
                >
                  ...
                  <svg
                    ...
                    strokeLinejoin="round"
                    aria-hidden
                    className={`h-3 w-3 shrink-0 text-slate-300 transition-transform duration-200 ${open ? "rotate-90" : ""}`}
                  >
                    ...
                    {section.items.map((m) => {
                      ...
                      return (
                        ...
                        >
                          <NavIcon
                            name={m.icon}
                            className={`h-[15px] w-[15px] shrink-0 transition-opacity ${active ? "opacity-100" : "opacity-50 group-hover:opacity-80"}`}
                          />
          ...
          <div className="flex items-center justify-between rounded-lg border border-slate-200 bg-white px-3 py-2">
            <div className="flex items-center gap-1.5 text-[11px]">
              ...
              <span className="text-slate-500">
                {aiStatus === "connected" ? "AI connected" : aiStatus === "error" ? "AI error" : anthropicReady ? "AI ready" : "AI not set"}
              </span>
            </div>
            <Link
