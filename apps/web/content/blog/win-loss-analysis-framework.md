---
title: "Win/Loss Analysis Framework: how to run it and what to do with the findings"
description: "A win/loss analysis framework for B2B teams — how to design the interviews, what questions to ask, and how to turn findings into positioning and campaign improvements."
date: "2026-07-24"
...
For the competitive intelligence that feeds into your battlecards from win/loss data, see the [competitive messaging framework](/blog/competitive-messaging-framework-b2b-saas). For how win/loss findings feed back into ICP refinement, see the [ICP framework](/blog/ideal-customer-profile-icp-framework).
