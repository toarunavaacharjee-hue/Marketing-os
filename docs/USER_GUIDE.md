...
> **In-app Help** at `/dashboard/help` loads [`apps/app/content/user-guide.md`](../apps/app/content/user-guide.md). Edit that file for what users see in the product; mirror substantive changes here so the repo copy stays aligned.
