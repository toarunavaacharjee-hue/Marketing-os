      ...
      <main className="relative mx-auto max-w-5xl px-4 pb-24 pt-[5.5rem] sm:px-6">
        <header className="mt-10">
          ...
          <p className="mt-5 max-w-2xl text-lg leading-relaxed text-text2">
            Everything you need to learn more about AI Marketing Workbench.
          </p>
        </header>

        <section className="mt-10 grid gap-4 md:grid-cols-3">
          {[
            ["/about", "About", "Mission, principles, and what we’re building."],
            ["/careers", "Careers", "Join the team building the GTM operating system."],
            ["/contact", "Contact", "Questions, partnerships, or support—reach out."]
          ].map(([href, label, desc]) => (
